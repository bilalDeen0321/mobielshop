...
<section class="container mx-auto px-4 py-10 max-w-3xl space-y-4 text-sm text-gray-600">
    ...
    <p>Eligible devices are supplied with at least 12 months warranty covering manufacturing and hardware faults.</p>
    <h2 class="text-base font-semibold text-gray-900 mt-4">Use of the website</h2>
    <p>You agree not to misuse this website, attempt unauthorised access or interfere with other users.</p>
</section>
@endsection
