...
<section class="container mx-auto px-4 py-10">
    ...
    @else
        <div class="grid gap-8 lg:grid-cols-[2fr,1fr]">
            <div class="space-y-4">
                ...
                <div class="flex items-center gap-4 border border-gray-200 rounded-md p-3 bg-white">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm font-medium text-primary mt-1">£{{ number_format((float) $item['product']->base_price, 2) }}</p>
                    </div>
            ...
            @php $subtotal = $cartItems->sum(fn ($i) => $i['product']->base_price * $i['quantity']); @endphp
